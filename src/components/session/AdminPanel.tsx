...
export default function AdminPanel({ session, participants, courts }: AdminPanelProps) {
    ...
    <div className="grid gap-6 animate-in fade-in-50">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>More admin controls will be available here soon.</CardDescription>
            </CardHeader>
            <CardContent>
                <p className="text-muted-foreground italic">
                    Future features could include: managing participants, adjusting session settings, viewing payment statuses, and more.
                </p>
            </CardContent>
        </Card>
    </div>
