...
const PLACEHOLDER_QR_CODE = "data:image/png;base64,.png";
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(sessionPayDoc, (s) => {
      if (s.exists()) {
        ...
        // Inject the placeholder QR if one isn't set in the database
        if (data.eWallets?.gcash && !data.eWallets.gcash.qrUrl) {
            data.eWallets.gcash.qrUrl = PLACEHOLDER_QR_CODE;
        }
        setCfg(data);
      } else {
          ...
          setCfg({
              ...
              currency: 'PHP',
              eWallets: {
                  gcash: { accountNumber: '09171234567', qrUrl: PLACEHOLDER_QR_CODE },
